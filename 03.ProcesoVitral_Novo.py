...
vCliente = 'Novonordisk'
vDAASSismed = 'C:/DAAS/02.daas_sismed_v2/PARQUET/'
vDAASMipres = 'C:/DAAS/01.daas_mipres_v2/'
vCarpetaCliente = 'C:/QsGJX/05.DesarrollosClientes/35.Novonordisk/Vitral/'
...
#FC.fCrearBaseParaProyectar(vCliente, vDAASSismed, 202001, vCarpetaCliente, 'AMBOS', 'TODAS', vUsarCUMMedicamentoGrupo)
